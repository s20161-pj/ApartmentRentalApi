...
namespace ApartmentRental.Core.DTO
{
    public class ApartmentBasicInformationResponseDto
    {
        ...
        public ApartmentBasicInformationResponseDto(decimal rentAmount, int numberOdRooms, decimal squareMeters, bool isElevatorInBuilding, string city, string street)
        {
